                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                               data-toggle="table" data-url="{{ route('advertisement.show','requested') }}" data-click-to-select="true"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="featured_status" data-sortable="true" data-filter-control="select" data-filter-data="" data-formatter="featuredItemStatusFormatter">{{ __('Featured/Premium') }}</th>
                                ...
                                <th scope="col" data-field="created_at" data-sortable="true" data-visible="false" data-switchable="false">{{ __('Created At') }}</th>
                                <th scope="col" data-field="updated_at" data-sortable="true" data-visible="false" data-switchable="false">{{ __('Updated At') }}</th>
                                <th scope="col" data-field="user_id" data-sortable="true" data-visible="false" data-switchable="false">{{ __('User ID') }}</th>
