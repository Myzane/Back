                 ...
                 <div class="form-group col-md-4 col-sm-12">
                    ...
                    <div class="d-flex mb-2">
                        <input type="text" name="longitude[]" class="form-control me-2" placeholder="Enter Longitude">
                         <button type="button" class="btn btn-danger remove-city-button">-</button>
                    </div>
                    </div>
                </div>
            </div>
        `);
        $cityContainer.append($newCityInputGroup);
    });

    // Event delegation to handle dynamically added remove buttons
    $cityContainer.on('click', '.remove-city-button', function () {
